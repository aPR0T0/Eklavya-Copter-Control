...
def moment_desired(roll_desired, pitch_desired, yaw_desired,orientation, w_x_current, w_y_current, w_z_current, I, kq,kr,flag,dTime):
    """
    ...
    global p0, p1, p2, p3, q0, q1, q2, q3, q_w_error, q_x_error, q_y_error, q_z_error, sign_q_w_error, current_time, prev_time
    global q_v_error, w_desired, curr_w_error, prev_w_err, q_intermediate_1, q_intermediate_2, q_intermediate_3_1, q_intermediate_3_2, M_desired
    ...
    quaternion_current = orientation
    ...
    # print(q_intermediate_1,prev_w_err,q_intermediate_3_1, dTime)
    # print(q_intermediate_3_2)
