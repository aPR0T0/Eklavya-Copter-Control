...
speed_ = Actuators()
speed_.angular_velocities.append(0)
speed_.angular_velocities.append(0)
speed_.angular_velocities.append(0)
speed_.angular_velocities.append(0)
speed_.angular_velocities.append(0)
...
def get_position_current(msg):
    ...
    current_position_returned[0][0] = (msg.pose.pose.position.x)
    current_position_returned[1][0] = (msg.pose.pose.position.y)
    current_position_returned[2][0] = (msg.pose.pose.position.z)
...
def master(imu_subscriber, odometry_subscriber):
    ...
    M_desired = moment_desired(quaternion_desired, quaternion_current, euler_current, euler_desired, w_current, Inertial_Matrix, kq, kr, flag )
    ...
    speed_publisher = get_speed_publisher(F_dec, Mu, flag, splitting_constant, speed_)
