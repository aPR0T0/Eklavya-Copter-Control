...
def moment_desired(quaternion_desired, quaternion_current, euler_current, euler_desired, w_current, I, kq, kr, flag ):
    """
    ...
    #print(w_current)
    roll_desired = euler_desired[0]
    pitch_desired = euler_desired[1]
    yaw_desired = euler_desired[2]
    roll = euler_current[0]
